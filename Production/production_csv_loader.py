...
class ProductionCSVLoader:
    ...
    def get_or_create_game(self, game_id: str, season: int, week: int, season_type: str = 'regular') -> Optional[int]:
        ...
        try:
            ...
            logger.debug(f"Creating game record: {game_id}")
            self.cursor.execute("""
        ...
        try:
            ...
            with open(csv_path, 'r', encoding='utf-8') as f:
                ...
                for row in reader:
                    ...
                    # Insert/update player_game_stats
                    self.cursor.execute("""
                    ...
                    """, (
                        ...
                        stats['rushing_attempts'], stats['rushing_yards'], stats['rushing_touchdowns'],
                        stats['receiving_yards'], stats['receiving_touchdowns']
                    ))
